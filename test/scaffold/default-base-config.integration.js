...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    aidpd.spawn.datadir.should.equal(home + '/.aidp');
    aidpd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/aidpd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.aidpd.spawn.datadir.should.equal('./data2');
  });
});
