...
module.exports.services.Aidpcoin = require('./lib/services/aidpd');
...
module.exports.cli.aidpcore = require('./lib/cli/aidpcore');
module.exports.cli.aidpcored = require('./lib/cli/aidpcored');

module.exports.lib = require('aidpcore-lib');
