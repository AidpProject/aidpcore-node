...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.aidp', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/aidpcore-node.json';
      ...
      config.services.should.deep.equal(['aidpd', 'web']);
      config.servicesConfig.aidpd.spawn.datadir.should.equal('./data');
