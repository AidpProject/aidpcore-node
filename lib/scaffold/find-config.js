...
/**
 * Will return the path and aidpcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'aidpcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'aidpcore-node.json'))
  };
}
